      ...
      <div className="row grey lighten-5">
          ...
          <div className="row">
              <social className="row center" id="map">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1tM2gArCqJwi4Bgz1r7Zv7RR7vbGMIEYr/view?usp=sharing " title="RESUME"><img className="social-icons text-center mt-4" alt="resume" src={drive} width="64" height="64"></img></a>
